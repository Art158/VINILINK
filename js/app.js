(() => {
    ...
    function initSliders() {
        if (document.querySelector(".swiper")) {
            new swiper_core_Swiper(".first__slider", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                slidesPerView: 1.1,
            ...
            new swiper_core_Swiper(".oils__slider", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                slidesPerView: 1.9,
            ...
            new swiper_core_Swiper(".brands-t", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                slidesPerView: 5,
            ...
            new swiper_core_Swiper(".auto-parts__slider", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                slidesPerView: 1.9,
                ...
                simulateTouch: false,
                navigation: {
                    prevEl: ".auto-parts-button-prev",
                    nextEl: ".auto-parts-button-next"
                },
                breakpoints: {
                    640: {
                        slidesPerView: 1.9,
            ...
            new swiper_core_Swiper(".pr-item__slider", {
                ...
                on: {
                    init: swiper => {
                        const slider = swiper.el.closest(".pr-item").querySelector(".pr-item__slider");
                        ...
                        slider.addEventListener("mousemove", (e => {
                            ...
                            if (swiper.slides && swiper.slides.length > 0) {
                                const targetSlideIndex = Math.floor(percentage * swiper.slides.length);
            ...
            new swiper_core_Swiper(".brands-b", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                slidesPerView: 5,
